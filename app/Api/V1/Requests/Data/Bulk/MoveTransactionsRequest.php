...
class MoveTransactionsRequest extends FormRequest
{
    ...
    {
        return [
            'original_account'    => 'required|different:destination_account|belongsToUserGroup:accounts,id',
            'destination_account' => 'required|different:original_account|belongsToUserGroup:accounts,id',
        ];
    }
