 ...
 * Class BelongsUser
 */
class BelongsUserGroup implements Rule
{
    /**
    ...
    {
        return (string) trans('validation.belongs_user_group');
    }
    ...
    public function passes($attribute, $value): bool
    {
        ...
        return match ($attribute) {
            ...
            default => throw new FireflyException(sprintf('Rule BelongUserGroup cannot handle "%s"', $attribute)),
        };
    }
