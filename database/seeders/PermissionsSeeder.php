...
class PermissionsSeeder extends Seeder
{
    public function run()
    {
        $arrayOfPermissionNames = [
            ...
            'transactions.read',
            'transactions.update',
            'transactions.update.withdrawal',
            'transactions.update.deposit',
            'transactions.update.transfer',
            'transactions.delete',
            'transactions.delete.withdrawal',
            'transactions.delete.deposit',
            'transactions.delete.transfer',
            'transactions.mass',
            'transactions.bulk',
